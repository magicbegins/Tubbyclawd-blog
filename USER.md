...
- **Implementation Preference:** Favors full end‑to‑end solutions that fail loudly and are easy to debug over isolated snippets; prioritizes time savings and reliability over elegance.
